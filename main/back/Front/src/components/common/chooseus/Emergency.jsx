    ...
    <>
      <section className="emergency-call">
        <div className="container-em">
          <div className="emergency-call__items">
            <div className="emergency-call__item">
              <div className="icon">
              ...
              <div className="content">
                <h1 style={{ direction: "rtl" }}>خدمة 12 ساعة</h1>
                <p style={{ direction: "rtl" }}>
                   للسرعة وسهولة الوصول
                </p>
              </div>
            </div>
            <div className="emergency-call__item">
              ...
              <div className="content">
                <h1 style={{ direction: "rtl" }}>خدمات مختبر متكاملة </h1>
                <p style={{ direction: "rtl" }}>خدمات معملية فعالة وشاملة</p>
              </div>
            </div>
            <div className="emergency-call__item">
              <div className="icon">
              ...
              <div className="content">
                <h1 style={{ direction: "rtl" }}>محترفين طبيا</h1>
                <p style={{ direction: "rtl" }}>أطباء مؤهلون ومعتمدون</p>
              </div>
            </div>
          </div>
          ...
          <div className="call">
            ...
            <a href="tel:920029292">920029292</a>
          </div>
        </div>
      </section>
    </>
