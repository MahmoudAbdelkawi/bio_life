...
// import icons
import Cardiology from '../../images/icon/cardiology.png'
import Dental from '../../images/icon/dental.png'
import Diagnostics from '../../images/icon/diagnostics.png'
import Gastroenterology from '../../images/icon/gastroenterology.png'
import Laboratory from '../../images/icon/laboratory.png'
import Ophtalmology from '../../images/icon/ophtalmology.png'
import Pulmonary from '../../images/icon/pulmonary.png'
import Urology from '../../images/icon/urology.png'


// FAKE ICONS
import Dermatology from '../../images/icon/urology.png'
import Psychiatry from '../../images/icon/urology.png'
					...
					<div className="row align-items-center">
						<div className="col-xl-4 col-lg-7 mb-30">	
							<div className="heading-bx">
								<h6 className="title-ext text-secondary">Departments</h6>
								<h2 className="title">We Cover A Big Variety Of Medical Departments</h2>
										...
										<div className="feature-box-xl mb-30" style={{display:'flex' , justifyContent:'center' , alignItems:'center'}}>
											<span className="icon-cell">
												{/* <svg enable-background="new 0 0 512 512" height="80" viewBox="0 0 512 512" width="80" xmlns="http://www.w3.org/2000/svg">	
													...
													<img src={icons[department.name]} alt=''  />
